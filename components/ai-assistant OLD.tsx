    ...
    setTimeout(() => {
      const aiMessage: Message = {
        ...
        content: selectedSession
          ? `Continuing our analysis on ${selectedSession}. Based on your request about "${input}", I'll provide additional insights for this session.`
          : `I've analyzed your request about "${input}". Based on current FX market conditions and volatility surfaces, I recommend reviewing your currency exposure allocation.`,
        timestamp: new Date(),
      }
